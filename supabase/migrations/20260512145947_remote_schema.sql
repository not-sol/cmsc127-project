...
ALTER TABLE ONLY "public"."export_records"
    ADD CONSTRAINT "export_records_generated_by_fkey" FOREIGN KEY ("generated_by") REFERENCES "public"."faculties"("faculty_id") ON UPDATE CASCADE;
...
ALTER TABLE ONLY "public"."faculties"
    ADD CONSTRAINT "faculties_faculty_id_fkey" FOREIGN KEY ("faculty_id") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."isip_authorship_forms"
    ADD CONSTRAINT "isip_authorship_forms_entry_id_fkey" FOREIGN KEY ("entry_id") REFERENCES "public"."accomplishment_entries"("entry_id");
...
ALTER TABLE ONLY "public"."reviews"
    ADD CONSTRAINT "reviews_reviewed_by_fkey" FOREIGN KEY ("reviewed_by") REFERENCES "public"."faculties"("faculty_id") ON UPDATE CASCADE;
