...
ALTER TABLE "public"."form_f_awards_and_grants" OWNER TO "postgres";


ALTER TABLE "public"."form_f_awards_and_grants" ALTER COLUMN "entry_id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."form_f_awards_and_grants_entry_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."form_f_awards_and_grants"
    ADD CONSTRAINT "form_f_awards_and_grants_pkey" PRIMARY KEY ("entry_id");
...
ALTER TABLE ONLY "public"."form_f_awards_and_grants"
    ADD CONSTRAINT "form_f_awards_and_grants_entry_id_fkey" FOREIGN KEY ("entry_id") REFERENCES "public"."accomplishment_entries"("entry_id");
...
ALTER TABLE "public"."form_f_awards_and_grants" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."form_f_awards_and_grants" TO "anon";
GRANT ALL ON TABLE "public"."form_f_awards_and_grants" TO "authenticated";
GRANT ALL ON TABLE "public"."form_f_awards_and_grants" TO "service_role";



GRANT ALL ON SEQUENCE "public"."form_f_awards_and_grants_entry_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."form_f_awards_and_grants_entry_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."form_f_awards_and_grants_entry_id_seq" TO "service_role";
